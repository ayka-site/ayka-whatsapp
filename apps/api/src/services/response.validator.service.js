...
16. For a parent fee enquiry, completeness includes the applicable fee components supplied by VERIFIED EVIDENCE for the requested class. If the evidence gives monthly tuition plus additional/one-time and annual charges, approvedReply MUST state those applicable charges separately even if the parent used wording such as "monthly fees". Do not silently omit an applicable non-monthly charge from the same class-wise fee structure. Fees for unrelated services or optional items should not be volunteered unless requested or necessary to explain the structure.`
